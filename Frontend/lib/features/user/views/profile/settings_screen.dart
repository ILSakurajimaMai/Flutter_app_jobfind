...
/// Chứa các tùy chọn bật/tắt thông báo, giao diện tối (Dark mode), và tính năng Đăng xuất.
...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
  ...
  /// Hộp thoại nhắc (Alert Dialog) trượt lên để hỏi người dùng thao tác chắc chắn thoát.
  /// Bấm Confirm thì gọi phương thức `logout()` của [authProvider.notifier] để xóa sạch cache.
  ...
  /// Hiển thị cột Widget Cài đặt tùy chỉnh (Dark mode, Push Notifications, Change Password...)
  @override
